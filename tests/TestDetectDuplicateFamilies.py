import unittest
from GedcomDataReader import detect_duplicate_families

class TestFilterDuplicateFamilies(unittest.TestCase):
...
'I16': {'name': 'Warren/Goldsmith/', 'sex': 'M', 'birth': '1990-02-04', 'death': 'Unknown'}}
    ...
    def test_no_duplicates(self):
        ...
        filtered = detect_duplicate_families(self.individuals, self.families)
        self.assertEqual(len(filtered), 0)
        
    def test_with_duplicates(self):
        """Test with duplicates."""
        filtered = detect_duplicate_families(self.individuals, self.families_with_duplicates)
        self.assertEqual(len(filtered), 2)
        
    def test_with_duplicates_and_duplicate_individuals(self):
        """Test with duplicates."""
        filtered = detect_duplicate_families(self.individuals_with_duplicates, self.families_with_duplicates)
        self.assertEqual(len(filtered), 2)
